...
(x, y, d), (sx, sy, wx, wy) = reduce(
  lambda o, t: (
    lambda x, y, d, i, v: ((
      x if i not in "EWF" else x + v if i == "E" or (i == "F" and d == 0) else x - v
      if i == "W" or (i == "F" and d == 2) else x
    ), (
  ...
  lambda o, t: (
    lambda sx, sy, wx, wy, i, v: ((sx if i != "F" else wx * v + sx), (sy if i != "F" else wy * v + sy), (
      ...
      if (i == "L" and v != 270) or (i == "R" and v == 270) else (-wx if v == 180 else wy)
      if (i == "R" and v != 270) or (i == "L" and v == 270) else wx
    ), (
