...
contest = next(T for T in reversed(range(ceil(10**14/mx)*mx,ceil(10**15/mx)*mx, mx)) if all(T%b==o for o,b in mes))
print((min(bus)[0]-e)*min(bus)[1], contest-mo)
# takes ~4 mins at magic 1op 4GHz (1047729918510 T in range(10**14,10**15,859), ~10**12 / 4*10**9 is ~250s)
