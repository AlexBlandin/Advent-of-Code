...
def find_encoding(signals):
  return next(
    ...
    if mid not in zero and mid not in one and mid not in seven
    and up not in one and up not in four
    and down not in one and down not in four and down not in seven
    and tl not in one and tl not in two and tl not in three and tl not in seven
    and bl not in one and bl not in three and bl not in four and bl not in five and bl not in seven and bl not in nine
    and br not in two
    and tr not in five and tr not in six
  )
result = 0
for line in lines:
