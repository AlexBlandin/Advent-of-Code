...
print(
  sum(filesize for path, filesize in size.items() if path in dirs and filesize <= 100000),
  min(filesize for path, filesize in size.items() if path in dirs and filesize >= free_up),
)
